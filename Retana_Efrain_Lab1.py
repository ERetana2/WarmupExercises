...
def draw_triangles(ax,n,s):
    ax.plot([0.5, 0.25], [0, 0.5], linewidth=0.5 ,color='k') #right line
    ax.plot([0, 0.25], [0, 0.5], linewidth=0.5 ,color='k') #left line
    ax.plot([0, 0.5], [0, 0], linewidth=0.5 ,color='k') #bottom line
    
    ax.plot([0.25,0.5], [0, 0.5], linewidth=0.5 ,color='k') #right line
    ax.plot([0.25,0], [0, 0.5], linewidth=0.5 ,color='k') #left line
    ax.plot([.5 , 0], [.5, .5], linewidth=0.5 ,color='k') #bottom line
...
def drawCirlces(ax, n , center ,radius): #draw a circle recursively
    if n>0:
        x,y = circle(center,radius)
        ax.plot(x,y,linewidth=0.5,color='k')
        drawCirlces(ax,n-1,[center[0] ,center[1]],radius/1.25)
